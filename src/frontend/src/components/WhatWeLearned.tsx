  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        {takeaways.map(
          (
            { emoji, title, description, color, bg, border, gradient },
            index,
          ) => (
            <div
              key={title}
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.72 0.22 220 / 0.12), oklch(0.68 0.26 295 / 0.12))",
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, oklch(0.72 0.22 220), oklch(0.68 0.26 295), oklch(0.72 0.30 340))",
          }}
        />
        ...
        <p
          ...
          style={{
            background:
              "linear-gradient(135deg, oklch(0.72 0.22 220), oklch(0.68 0.26 295), oklch(0.72 0.30 340))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
            backgroundClip: "text",
          }}
