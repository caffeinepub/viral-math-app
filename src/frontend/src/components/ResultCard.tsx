...
export function ResultCard({
  ...
  const glowMap = {
    "pink-purple":
      "0 0 40px oklch(0.72 0.30 340 / 0.35), 0 0 80px oklch(0.68 0.26 295 / 0.18)",
    "cyan-green":
      "0 0 40px oklch(0.82 0.20 195 / 0.35), 0 0 80px oklch(0.78 0.22 145 / 0.18)",
    "purple-pink":
      "0 0 40px oklch(0.68 0.26 295 / 0.35), 0 0 80px oklch(0.72 0.30 340 / 0.18)",
  };
