    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-3xl p-6 text-center relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 0%, oklch(0.72 0.28 340 / 0.12), transparent 70%)",
          }}
        />
        ...
        >
          ...
          <div className="px-5 pt-5 pb-3 relative">
            <div
              ...
              style={{
                background: `linear-gradient(90deg, ${category.color}, ${category.colorAlt})`,
              }}
            />
            ...
            {category.items.map((tip) => (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-3 mb-2">
                  ...
                  <span
                    className="flex-shrink-0 text-xs font-bold rounded-full px-2 py-0.5 whitespace-nowrap"
                    style={{
      ...
      <div className="glass-card rounded-3xl p-6 text-center relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 100%, oklch(0.68 0.26 295 / 0.10), transparent 70%)",
          }}
        />
        ...
        <p className="text-xs text-muted-foreground">
          Use the calculators to see exactly where your content stands.
          Knowledge is power. 💪
        </p>
      </div>
    </div>
