...
export function EngagementBarChart({ likes, comments, shares }: EngagementBarChartProps) {
  const data = [
    { label: '❤️ Likes', value: likes, color: '#f472b6', glow: 'oklch(0.72 0.30 340 / 0.50)' },
    { label: '💬 Comments', value: comments, color: '#818cf8', glow: 'oklch(0.68 0.26 295 / 0.50)' },
    { label: '🔁 Shares', value: shares, color: '#22d3ee', glow: 'oklch(0.82 0.20 195 / 0.50)' },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(90deg, oklch(0.72 0.30 340), oklch(0.68 0.26 295), oklch(0.82 0.20 195))' }}
      />
