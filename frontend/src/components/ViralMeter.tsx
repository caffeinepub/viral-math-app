...
export function ViralMeter({ engagementRate }: ViralMeterProps) {
  ...
  const zoneConfig = {
    low: { label: '🔴 Low Viral Chance', color: '#ef4444', bg: 'oklch(0.45 0.22 25 / 0.15)', border: 'oklch(0.55 0.22 25 / 0.40)' },
    medium: { label: '🟡 Medium Viral Chance', color: '#eab308', bg: 'oklch(0.75 0.20 85 / 0.15)', border: 'oklch(0.75 0.20 85 / 0.40)' },
    high: { label: '🟢 High Viral Chance', color: '#22c55e', bg: 'oklch(0.65 0.22 145 / 0.15)', border: 'oklch(0.65 0.22 145 / 0.40)' },
  };
    ...
    >
      ...
      <div className="flex justify-center">
        <svg width="240" height="130" viewBox="0 0 240 130" className="overflow-visible">
          ...
          {/* Zone labels */}
          <text x="18" y="118" fontSize="9" fill="#ef4444" fontWeight="bold" opacity="0.9">LOW</text>
          <text x="100" y="42" fontSize="9" fill="#eab308" fontWeight="bold" opacity="0.9" textAnchor="middle">MED</text>
          <text x="210" y="118" fontSize="9" fill="#22c55e" fontWeight="bold" opacity="0.9" textAnchor="end">HIGH</text>
